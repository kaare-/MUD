//! Volume-conserving Press displace (DESIGN.md §2.4).
//!
//! Separate from the Clay Add/Remove brush (`brush.rs`), which stays
//! soft-CSG ± heuristic bulge. Press:
//!
//! 1. Depresses the surface with a soft spherical tool stamp.
//! 2. Measures volume lost (`∆V⁻`).
//! 3. Redistributes that volume into a rim recruitment kernel
//!    (sideways / behind the press).
//! 4. Runs a few local redistance iterations so φ stays usable.
