...
| `L` | Pull — grows the surface, thins the rim (volume conserved) |
| `K` | Knife — shallow hard remove (drag a kerf; no volume recruit) |
...
| — | Preferences — stylus pressure → depth / engagement; altitude leans Knife / Paddle |
